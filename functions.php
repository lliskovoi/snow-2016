...
function twentysixteen_widgets_init() {
    ...
    register_sidebar(
        array(
            'name'          => __('Home Left', 'twentysixteen'),
            'id'            => 'home-left',
            'description'   => __('Left textbox on homepage', 'twentysixteen'),
    ...
    register_sidebar(
        array(
            'name'          => __('Home Middle', 'twentysixteen'),
            'id'            => 'home-middle',
            'description'   => __('Middle textbox on homepage', 'twentysixteen'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h2>',
            'after_title'   => '</h2>'
    ...
    register_sidebar(
        array(
            'name'          => __('Home Right', 'twentysixteen'),
            'id'            => 'home-right',
            'description'   => __('Right textbox on homepage', 'twentysixteen'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h2>',
            'after_title'   => '</h2>'
    ...
    register_sidebar(
        array(
            ...
            'id'            => 'header-right',
            'description'   => __('Right header', 'twentysixteen'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h2>',
            'after_title'   => '</h2>'
